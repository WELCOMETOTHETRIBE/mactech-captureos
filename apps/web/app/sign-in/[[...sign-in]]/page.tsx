...
/**
 * Sign-in page — warm-paper variant. The previous obsidian-and-copper
 * shell promised a different product than the warm-paper authenticated
 * app the user reached one click later. This shell now matches.
 *
 * Clerk `appearance` is derived from the token contract via Tailwind
 * utility classes only — no inline hex, no template-string `bg-[${VAR}]`.
 * If you need a different color, change the CSS var, not this map.
 */
          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-7">
              ...
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                Use your MacTech account to access pursuits, opportunities, and
                capture intel.
              </p>
            </div>
