...
const ACCENT = "#48b3ac"; // brand-400 — readable on dark bg
const BUTTON = "#207b78"; // brand-600
const BUTTON_HOVER = "#1c6362"; // brand-700
const BUTTON_ACTIVE = "#1a504f"; // brand-800
const FOOTER_LINK_HOVER = "#7bcdc7"; // brand-300
